classdef RREnvTrain < handle
    ...
    methods
        ...
        % CONSTRUCTOR %
        function ENV = RREnvTrain(puck,mallet,table,e,speed,mode,createMov)
        ...
        function train(ENV)
            input = [ENV.puck.obj.Position(1:2),ENV.puck.v,ENV.p1.obj.Position(1:2)];
